...
(Web version of Linear_Regression_Scalar.py)

Trains Logistic Regression on PlacementStatus three times:
  1. Unscaled
  2. StandardScaler
  3. MinMaxScaler
...
def run_linear_regression_scalar() -> dict:
    ...
    # ---- 3. unscaled --------------------------------------
    _, unscaled_result, _ = _train_and_evaluate(
    ...
    # ---- 6. confusion matrix (StandardScaler model) -------
    ...
    return {
        ...
        "report": classification_report(y_test, standard_pred),
    }